<%@ page language="C#" autoeventwireup="true" inherits="JobReceivedReport, App_Web_olx2vwmy" enableeventvalidation="false" %>
...
<body>
    ...
    <div>
        ...
        <%--<asp:TemplateField>
            <HeaderTemplate><asp:DropDownList OnSelectedIndexChanged="custname_OnSelectedIndexChanged" ID="dd_custname" AutoPostBack="true" runat="server"></asp:DropDownList></HeaderTemplate>
            <ItemTemplate><%# DataBinder.Eval(Container.DataItem,"CUSTOMER NAME") %></ItemTemplate>
        </asp:TemplateField>--%>
        ...
        <%--<asp:BoundField DataField="JOB STAGE" HeaderText="JOB STAGE"/>--%>
        ...
        <%--<asp:TemplateField>
        <HeaderTemplate>
        <asp:DropDownList OnSelectedIndexChanged="duedate_OnSelectedIndexChanged" AutoPostBack="true" ID="dd_duedate" runat="server" ></asp:DropDownList>
        </HeaderTemplate>
        <ItemTemplate>
        <%# DataBinder.Eval(Container.DataItem, "[DUE DATE]")%>
        </ItemTemplate>
        </asp:TemplateField>--%>
        <asp:BoundField DataField="DUE DATE" HeaderText="DUE DATE"/>
        <%--<asp:TemplateField>
        <HeaderTemplate>
            <asp:DropDownList OnSelectedIndexChanged="catsduedate_OnSelectedIndexChanged" AutoPostBack="true" ID="dd_catsduedate" runat="server" ></asp:DropDownList>
        </HeaderTemplate>
        <ItemTemplate><%# DataBinder.Eval(Container.DataItem,"[CATS DUE DATE]") %></ItemTemplate>
        </asp:TemplateField>--%>
        ...
        <asp:BoundField DataField="DELIVERY" HeaderText="DELIVERY" />
		   <asp:BoundField DataField="Supervisor"  HeaderText="Supervisor Name" />
