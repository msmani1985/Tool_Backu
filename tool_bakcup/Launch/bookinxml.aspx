<%@ page language="C#" autoeventwireup="true" inherits="bookinxml, App_Web_opij0lkt" enableeventvalidation="false" %>
...
<body>
    ...
    <tr><td><asp:GridView ID="gv_xmljob" runat="server" AutoGenerateColumns="false" CssClass="lightbackground"
        AlternatingRowStyle-CssClass="dullbackground" HeaderStyle-CssClass="darkbackground">
            <Columns>
                ...
                <asp:BoundField DataField="received_date" HeaderText="Received Date" DataFormatString="{0:dd/MM/yyyy}" />
                <asp:BoundField DataField="due_date" HeaderText="Due Date" DataFormatString="{0:dd/MM/yyyy}" />
                <asp:BoundField DataField="despatch_date" HeaderText="Dispatch Date" DataFormatString="{0:dd/MM/yyyy}" />
    ...
    <div id="div_error" class="errorMsg" runat="server">No Record's Found</div>
    </form>
</body>
</html>
