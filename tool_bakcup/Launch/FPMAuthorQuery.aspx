<%@ page language="C#" autoeventwireup="true" inherits="FPMAuthorQuery, App_Web_yf2wiypp" enableeventvalidation="false" %>
        ...
        <tr><td>
         ...
         <asp:GridView  Width="650px" ID="gv_samfollowup" runat="server" AutoGenerateColumns="false" 
            ...
            <asp:BoundField HeaderText="Editor Correction" DataField="correction_type" />
                    <asp:BoundField HeaderText="Author Reminder Followup Email" DataField="follow_email_sent" DataFormatString="{0: MM/dd/yyyy}" HtmlEncode="false" />
