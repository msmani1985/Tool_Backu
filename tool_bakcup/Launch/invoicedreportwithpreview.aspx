<%@ page language="C#" autoeventwireup="true" inherits="invoicedreport, App_Web_lruasnqi" %>
...
<body>
    ...
    <div >
            <table class="bordertable" align="center" cellpadding="2" cellspacing="2" style="width:450px;" >
                ...
                <img style="cursor:pointer; border:none" alt="Calendar" onclick="javascript:calendar_window=window.open('calendar.aspx?formname=todate','calendar_window','width=180,height=170,left=450,top=400,toolbars=no,scrollbars=yes,status=no,resizable=no');calendar_window.focus()" src="images/Calendar.jpg" height="20px" border="0" />
                </td></tr>            
            </table>
    </div> 
    <br />
    ...
    <div>
        <CR:CrystalReportViewer ID="PDFTandFCReportViewer" runat="server" AutoDataBind="true" DisplayGroupTree="false" EnableDatabaseLogonPrompt="False" EnableParameterPrompt="False" HasToggleGroupTreeButton="False" />
    </div>
    <div style="text-align:center;width:100%; z-index:10;"  >
            ...
            AllowSorting="True" width="90%" runat="server" AutoGenerateColumns="False"
				...
				<Columns>
					...
					<asp:TemplateColumn  HeaderText="Customer" Visible=False SortExpression="CNAME">
						<ItemTemplate>
					...
					<asp:TemplateColumn  HeaderText="Supplier Invoice No." SortExpression="IINNO">
						<ItemTemplate>
