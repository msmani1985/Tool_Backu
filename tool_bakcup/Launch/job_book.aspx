<%@ page language="C#" autoeventwireup="true" inherits="job_book, App_Web_olx2vwmy" enableeventvalidation="false" maintainscrollpositiononpostback="true" %>
                    ...
                    <td>
                        <ol id="toc">
                            ...
                            <li id="mijobtrack" runat="server">
                                <asp:LinkButton ID="lnkJobTrack" runat="server" OnClick="lnkJobTrack_Click" TabIndex="12">Job Track</asp:LinkButton>
                            </li>    
                        </ol>
                            ...
                            <div id="PARENT_JOB" class="boxTable" style="">
                                <table id="XMLTAGS" border="0" width="100%" cellpadding="2" cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtBookOISBN" runat="server" CssClass="TxtBox" Width="200px" MaxLength="16"
                                                ...
                                                <td>
                                            Invoice Job Location: <span style="font-size: 9pt; color: #ff0000"></span></td>
                                        <td >
                                            <asp:DropDownList ID="drpjobinvoicegroup" runat="server" TabIndex="33">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList ID="drpBookTypeset" runat="server" TabIndex="19">
                                             ...
                                             <td colspan="3"> <asp:CheckBox ID="chkBookOnHold" onclick="javascript:isBOnhold();" runat="server"
                                                Font-Bold="False" Text="On Hold" TabIndex="13" />
                                        <asp:LinkButton ID="lnkBookHold" runat="server" OnClick="lnkBookHold_Click"></asp:LinkButton>
                                                </td>
                                    ...
                                    <tr>
                                        ...
                                        <%--Completed Stages--%>
                                        <td align="left" colspan="3" rowspan="8" valign="top">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            Print Pages:</td>
                                        <td>
                                            <asp:TextBox ID="txtprintpages" runat="server" CssClass="TxtBox" MaxLength="100"
                                                Width="200px" TabIndex="21"></asp:TextBox></td>
                                    </tr>
                                    <tr>
                                        <td>
                        ...
                        <div class="content" id="tabChapterdetails" runat="server">
                            <table id="Table3" border="0" width="100%" cellpadding="2" cellspacing="0">
                                ...
                                <tr><td>
                                        ...
                                        <td>
                                        <asp:CheckBox ID="chkChapterOnHold" onclick="javascript:isCOnhold();" runat="server"
                                                Font-Bold="False" Text="On Hold" TabIndex="13" />
                                                <asp:LinkButton ID="lnkChapterHold" runat="server" OnClick="lnkChapterHold_Click"></asp:LinkButton>
                                    </td>
                                    <td>
                                    </td>
                                    <td>
                        ...
                        <div class="content" id="tabjobtrack" runat="server">
                            <table id="Table5" border="0" width="100%" cellpadding="2" cellspacing="0">
                                ...
                                <tr><td>
                                    <CR:CrystalReportViewer ID="CRV_jobtrackviewer" runat="server" AutoDataBind="true" />
                                </td></tr>
                            </table>
                        </div>
                    </td>
