<%@ page language="C#" autoeventwireup="true" inherits="job_pagination, App_Web_w6b3pav3" %>
    ...
    <form id="form1" runat="server">
        ...
        <table align="center" cellpadding="1" cellspacing="1" class="bordertable" style="width: 478px">
            <tr>
                ...
                <td colspan="5">
                    <asp:TextBox ID="txtJobNumber" runat="server" CssClass="TxtBox" Width="105px"></asp:TextBox>&nbsp;
        ...
        <div id="divPagination" runat="server">
            <table align="center" cellpadding="1" cellspacing="1" class="bordertable">
                <tr>
                    <td align="right">
                        <div style="float: left">
                            <asp:Label ID="lblIssue" runat="server" Font-Bold="True" ForeColor="Green" Font-Size="14px"></asp:Label></div>
                ...
                <tr>
                    <td align="right" colspan="6" style="width: 788px">
                ...
                <tr>
                    <td align="left" colspan="6" style="width: 788px">
                        <asp:GridView ID="gvPagination" CssClass="lightbackground" runat="server" Width="100%"
                            AutoGenerateColumns="False" ShowFooter="True" OnRowDataBound="gvPagination_RowDataBound" EnableViewState="true">
