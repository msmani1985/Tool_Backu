<%@ page language="C#" autoeventwireup="true" inherits="wrclientpage, App_Web_lruasnqi" %>
        ...
        <div>
            ...
            <table align="center" class="bordertable">
                ...
                <tr>
                    ...
                    <td>
                        <asp:Button ID="btnShowReport" runat="server" Text="Show Report" Width="98px" OnClick="Button1_Click"
                            CssClass="dpbutton" /></td>
                    <td>
                        <asp:Button ID="btnExport" runat="server" CssClass="dpbutton" Text="Export to Excel" Width="113px" OnClick="Button2_Click" /></td>
                </tr>
                <tr>
