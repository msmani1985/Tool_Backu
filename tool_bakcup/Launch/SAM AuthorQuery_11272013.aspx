<%@ page language="C#" autoeventwireup="true" inherits="SAMAuthorQuery, App_Web_w6b3pav3" enableeventvalidation="false" %>
         ...
         <asp:GridView  Width="650px" ID="gv_samfollowup" runat="server" AutoGenerateColumns="false" 
                ...
                <asp:TemplateField HeaderText="Author Email Sent">
                     <ItemTemplate>
                        ...
                        <img id="Author_mail_sent"  runat="server" style="cursor:pointer;border:none "  src="images/temail.jpg" height="20" alt="Email" title="Email" visible='<%# (DataBinder.Eval(Container.DataItem,"follow_email_sent")==null || DataBinder.Eval(Container.DataItem,"follow_email_sent").ToString()=="" )? true : false %>' /> <!--onclick deleted by gnanasekaran; dt:27-nov-->
                        <!--<img id="Img1"  runat="server" style="cursor:pointer;border:none "  src="images/temail.jpg" height="20" alt="Email" title="Email" onclick="btnEmailSent" visible='<%# (DataBinder.Eval(Container.DataItem,"follow_email_sent")==null || DataBinder.Eval(Container.DataItem,"follow_email_sent").ToString()=="" )? true : false %>' />-->
