<%@ page language="C#" autoeventwireup="true" inherits="Emp_Leave_OpBal, App_Web_ndoqnuzw" %>
...
<body>
    ...
    <tr>
                                ...
                                <tr>
                                <td align="left">
                                 <asp:GridView ID="grvLvl" runat="server"  autogeneratecolumns="false" emptydatatext="No data available."  Font-Size="9pt" OnRowDataBound="grvLvl_RowDataBound" Width="762px"  >
