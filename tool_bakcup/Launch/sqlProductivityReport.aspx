<%@ page language="C#" autoeventwireup="true" inherits="sqlProductivityReport, App_Web_opij0lkt" %>
...
<body>
    ...
    <div id="Div_Report" runat="server">
        ...
        HasRefreshButton="false" HasSearchButton="false" HasToggleGroupTreeButton="false" HasViewList="true" HasZoomFactorList="false" ShowAllPageIds="True"   />
    </div>
