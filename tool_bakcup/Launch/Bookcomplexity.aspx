<%@ page language="C#" autoeventwireup="true" inherits="Bookcomplexity, App_Web_lruasnqi" %>
...
<body>
    ...
    <div id="div_bookdetails" runat="server" align="center">
        <asp:GridView ID="gv_bookcomplexity" runat="server" CssClass="lightbackground" AutoGenerateColumns="false"
         AlternatingRowStyle-CssClass="dullbackground" HeaderStyle-CssClass="darkbackground" OnRowDataBound="div_bookdetails_onRowDataBound">
        <Columns>
            ...
            <asp:TemplateField>
            <HeaderTemplate>
                    <asp:ImageButton ID="img_complexitysave" runat="server" ImageUrl="~/images/tools/j_save.png" OnClick="img_complexitysave_click" />
                </HeaderTemplate>
                <ItemTemplate>
