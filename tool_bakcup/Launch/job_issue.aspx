<%@ page language="C#" autoeventwireup="true" enableeventvalidation="false" inherits="job_issue, App_Web_opij0lkt" %>
                    ...
                    <td>
                        <ol id="toc">
                            ...
                            <li id="miIssueAddCost" runat="server">
                                <asp:LinkButton ID="lnkIssueAddCost" runat="server" OnClick="lnkIssueAddCost_Click" TabIndex="6">Costing</asp:LinkButton></li>
                                ...
                                <table id="XMLTAGS" border="0" width="100%" cellpadding="2" cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            Half-Due Date:</td>
                                        <td>
                                            <asp:TextBox ID="txtIssueHDdate" runat="server" CssClass="TxtBox" Width="80px" TabIndex="22" BackColor="#F1F1F1"></asp:TextBox>
                                            <img align="absmiddle" alt="Calendar" border="0" height="20" onclick="javascript:calendar_window=window.open('calendar.aspx?formname=txtIssueHDdate','calendar_window','width=180,height=170,left=450,top=360,toolbars=no,scrollbars=no,status=no,resizable=no');calendar_window.focus()"
                                                src="images/Calendar.jpg" style="cursor: pointer;" id="imgID_hdudate" runat="server" tabindex="23" /></td>
                                        <td>
                                        </td>
                                    </tr>
                                    <tr>
