<%@ page language="C#" autoeventwireup="true" inherits="job_article, App_Web_oh7bpmkh" enableeventvalidation="false" validaterequest="false" %>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="2">
                                                        <asp:RadioButtonList ID="rblstAdvCompleted" runat="server" CellPadding="0" CellSpacing="0"
                                                            ...
                                                            <asp:ListItem Value="all">All Articles</asp:ListItem>
                                                        </asp:RadioButtonList></td>
                                                </tr>
                                                <tr>
                                                    <td style="width: 108px">
                                    ...
                                    <td colspan="5">
                                        <asp:GridView ID="gvArticles" runat="server" Width="100%" OnRowDataBound="gvArticles_RowDataBound"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Article No." SortExpression="articlecode" HeaderStyle-ForeColor="white">
                                                    <ItemTemplate>
                                ...
                                <table id="XMLTAGS" border="0" width="100%" cellpadding="2" cellspacing="0">
                                                            ...
                                                            <asp:DataGrid ID="dgrdArticleStages" runat="server" AutoGenerateColumns="False" CssClass="lightbackground">
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateColumn HeaderText="Cats Due Date">
                                                                      ...
                                                                      <ItemTemplate>
                                                                           <asp:Label ID="lblBD_ACatsDueDate" runat="server" Text='<%# Eval("cats_due_date","{0:MM/dd/yyyy}") %>'></asp:Label>
                                                                      </ItemTemplate>
                                                                                   </asp:TemplateColumn>
                                                                </Columns>
                                                            </asp:DataGrid></td>
                                    ...
                                    <tr>
                                        <td>
                                            SAM Author Query:</td>
                                        <td>
                                            <asp:TextBox ID="txt_SamAuthorQuery" runat="server" CssClass="TxtBox" TextMode="MultiLine" Height="50px" Width="300px"  TabIndex="27"></asp:TextBox>
                                            
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            Figure Correction Query:</td>
                                        <td>
                                            <asp:TextBox ID="txt_FigureQuery" runat="server" CssClass="TxtBox" TextMode="MultiLine" Height="50px" Width="300px"  TabIndex="27"></asp:TextBox>
