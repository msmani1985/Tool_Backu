<%@ page language="C#" autoeventwireup="true" inherits="Employee_Upload, App_Web_rxbwko6z" enableeventvalidation="false" %>
  ...
  <td class="dpheader" colspan="6" >
        ...
        <td>
            ...
            <asp:RadioButtonList ID="rbLocation" runat="server" RepeatDirection="Horizontal">
                <asp:ListItem Selected="True" Value="1">Chennai</asp:ListItem>
                <asp:ListItem Value="2">Coimbatore</asp:ListItem>
            </asp:RadioButtonList>
        </td></tr>
        <tr>
