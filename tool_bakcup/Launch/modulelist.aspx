<%@ page language="C#" autoeventwireup="true" inherits="modulelist, App_Web_lruasnqi" %>
...
<body>
    ...
    <div>
        ...
        <CR:CrystalReportViewer ID="CV_modulelist" runat="server" AutoDataBind="true" HasToggleGroupTreeButton="false" DisplayGroupTree="false" EnableDatabaseLogonPrompt="false" />
    </div>
    </form>
</body>
</html>
