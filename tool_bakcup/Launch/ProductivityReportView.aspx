<%@ page language="C#" autoeventwireup="true" inherits="ProductivityReportView, App_Web_w6b3pav3" %>
            ...
            <tr>
                ...
                <td align="left">
                    <asp:Button ID="btnExport" CssClass="button" runat="server" Enabled="False" OnClick="btnExport_Click"
                        OnClientClick="alert('Exporting to excel...');return;" Text="Save" Width="62px" />
                    <input id="Button1" class="button" type="button" value="Close[X]" onclick="javascript:self.close();"; /></td>
            </tr>
            <tr>
