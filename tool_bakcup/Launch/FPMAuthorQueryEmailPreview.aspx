<%@ page language="C#" autoeventwireup="true" inherits="FPMAuthorQueryEmailPreview, App_Web_q-mwnzq9" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>FPM Author Qurey Email Preview</title>
         ...
         <table >
            <tr>
                <td>
                    ...
                    <tr>
                        <td colspan="3" style="text-indent:5px; background:green;color:White;font-weight:bold;height:30px;vertical-align:middle; ">FPM Author Query Email Preview</td>
                    </tr>
                    <tr>
                        <td><b>From: </b></td><td><asp:label ID="lblFromAddress" runat="server" Text=""></asp:label></td>
                    ...
                    <tr><td><b>CC: </b></td>
                        ...
                        <tr><td>
                            ...
                            <td><asp:FileUpload ID="File_upload" runat="server" Width="390px" /></td>
                        </tr>
                        ...
                        <td colspan="3"><asp:LinkButton ID="HlnkloadFile" Text="View Attachment" runat="server"  OnClick="HlnkloadFile_Click"></asp:LinkButton> </td></tr>--%>
