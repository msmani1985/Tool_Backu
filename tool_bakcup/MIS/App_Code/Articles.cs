...
public class Articles
{
    ...
    private string sSql = "";
    public Articles(){oCust = new CustomerBase();
        oCom = new Common();
    ...
    public DataSet getArticleStages() { return this.oCom.getStagesByJobType(0, 5); }
    ...
    public string InsertArticle(string[] aArticle)
    {
        ...
        try
        {
            ...
            param[18] = oSql.NewParameter("@sam_author_query", SqlDbType.Text, int.MaxValue, ParameterDirection.Input, aArticle[18]);
            param[19] = oSql.NewParameter("@job_stage_id", SqlDbType.Int, int.MaxValue, ParameterDirection.Input, aArticle[19]);
            param[20] = oSql.NewParameter("@received_date", SqlDbType.VarChar, int.MaxValue, ParameterDirection.Input, aArticle[20]);
            param[21] = oSql.NewParameter("@due_date", SqlDbType.VarChar, int.MaxValue, ParameterDirection.Input, aArticle[21]);
            param[22] = oSql.NewParameter("@half_due_date", SqlDbType.VarChar, int.MaxValue, ParameterDirection.Input, aArticle[22]);
            param[23] = oSql.NewParameter("@despatch_date", SqlDbType.VarChar, int.MaxValue, ParameterDirection.Input, aArticle[23]);
            param[24] = oSql.NewParameter("@cats_due_date", SqlDbType.VarChar, int.MaxValue, ParameterDirection.Input, aArticle[24]);
            param[25] = oSql.NewParameter("@created_by", SqlDbType.Int, int.MaxValue, ParameterDirection.Input, aArticle[25]);
            param[26] = oSql.NewParameter("@sales_job_group_id", SqlDbType.Int, int.MaxValue, ParameterDirection.Input, aArticle[26]);
            param[27] = oSql.NewParameter("@ms_received_date", SqlDbType.VarChar, int.MaxValue, ParameterDirection.Input, aArticle[27]);
            param[28] = oSql.NewParameter("@ms_revised_date", SqlDbType.VarChar, int.MaxValue, ParameterDirection.Input, aArticle[28]);
            param[29] = oSql.NewParameter("@ms_accepted_date", SqlDbType.VarChar, int.MaxValue, ParameterDirection.Input, aArticle[29]);
            param[30] = oSql.NewParameter("@interviewdate", SqlDbType.VarChar, int.MaxValue, ParameterDirection.Input, aArticle[30]);
            param[31] = oSql.NewParameter("@phoneno", SqlDbType.VarChar, int.MaxValue, ParameterDirection.Input, aArticle[31]);
            param[32] = oSql.NewParameter("@faxno", SqlDbType.VarChar, int.MaxValue, ParameterDirection.Input, aArticle[32]);
            param[33] = oSql.NewParameter("@interviewtime", SqlDbType.VarChar, int.MaxValue, ParameterDirection.Input, aArticle[33]);
            param[34] = oSql.NewParameter("@meetingplace", SqlDbType.VarChar, int.MaxValue, ParameterDirection.Input, aArticle[34]);
            param[35] = oSql.NewParameter("@meetingtime", SqlDbType.VarChar, int.MaxValue, ParameterDirection.Input, aArticle[35]);
            param[36] = oSql.NewParameter("@country", SqlDbType.VarChar, int.MaxValue, ParameterDirection.Input, aArticle[36]);
            param[37] = oSql.NewParameter("@appointmentdate1", SqlDbType.VarChar, int.MaxValue, ParameterDirection.Input, aArticle[37]);
            param[38] = oSql.NewParameter("@appointmentdate2", SqlDbType.VarChar, int.MaxValue, ParameterDirection.Input, aArticle[38]);
            param[39] = oSql.NewParameter("@zone", SqlDbType.VarChar, int.MaxValue, ParameterDirection.Input, aArticle[39]);
