<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PR_Book_Despatched.aspx.cs" Inherits="PR_Book_Despatched" %>
...
<asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server"> </asp:ToolkitScriptManager>
        ...
        <ContentTemplate>--%>
                ...
                <tr>
                 ...
                 <tr>
                     ...
                     <td width="8px">
                         &nbsp;</td>
                     <td align="left">
                         <asp:RadioButtonList ID="rbInvoice" runat="server" RepeatDirection="Horizontal">
                    ...
                    <td>
                        ...
                        <asp:GridView ID="grdProductionReport" runat="server" AllowSorting="True" 
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="Btitle" HeaderText="Book Name" 
                                    SortExpression="Btitle"></asp:BoundField>
                                <asp:BoundField DataField="india_recd" HeaderText="India Rec'd Date" 
                                    SortExpression="india_recd"></asp:BoundField>
                                <%--<asp:BoundField DataField="DueDate" HeaderText="India Due Date" 
                                ...
                                <asp:BoundField DataField="bnoofpages" HeaderText="Pages" 
                                    SortExpression="bnoofpages" ></asp:BoundField>
                                <asp:BoundField DataField="binvoiced" HeaderText="Invoiced"
                                    SortExpression="binvoiced"></asp:BoundField>
            ...
            <%--<asp:HiddenField ID="hfgvInvoiceID" runat="server" Value='<%# Eval("ROWID") %>' />--%>        <%--</asp:Panel>--%>
    </form>
</body>
</html>
