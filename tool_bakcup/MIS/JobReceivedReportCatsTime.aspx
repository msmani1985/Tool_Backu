<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JobReceivedReportCatsTime.aspx.cs" Inherits="JobReceivedReport" %>
...
<body>
    <form id="form1" runat="server">
     <div class="dptitle" id="divTitle" align="left" runat="server">Job Despatch Report </div>
  ...
  <%--      <asp:BoundField DataField="Work Flow" HeaderText="WORK FLOW"/>--%>
        ...
        <asp:BoundField DataField="mailCatsDuedate" HeaderText="CATS DUE DATE"/>
        <asp:BoundField DataField="UploadTime" HeaderText="DESPATCH DATE"/>
        <asp:BoundField DataField="GMT" HeaderText="CATS NOTIFICATION" />
