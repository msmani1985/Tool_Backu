<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EmployeeReports.aspx.cs" Inherits="EmployeeReports" %>
...
<body>
    ...
    <div>
        <div align="center" style="overflow:auto;WIDTH:100%; height: 93px;" >
    <table align="center">
    <tr>
    <td align="center">
    Applied Date:<asp:TextBox ID="txtAppDate" runat="server"  ></asp:TextBox>&nbsp; 
        <img style="cursor:pointer; border: none" alt="Calendar" onclick="javascript:calendar_window=window.open('calendar.aspx?formname=txtAppDate','calendar_window','width=180,height=170,left=450,top=360,toolbars=no,scrollbars=no,status=no,resizable=no');calendar_window.focus()" src="images/Calendar.jpg" height="20px" border="0" />
    &nbsp; 
    </td>
    </tr>
        <tr>
            <td>
                From:<asp:TextBox ID="FromTxt" runat="server"  ></asp:TextBox>&nbsp; 
        <img style="cursor:pointer; border: none" alt="Calendar" onclick="javascript:calendar_window=window.open('calendar.aspx?formname=FromTxt','calendar_window','width=180,height=170,left=450,top=360,toolbars=no,scrollbars=no,status=no,resizable=no');calendar_window.focus()" src="images/Calendar.jpg" height="20px" border="0" />
...
<%--                <asp:TemplateField ShowHeader="False">
    ...
    <div>
        ...
        <tr>
                ...
                <td align="right" style="width: 170px; height: 20px;"><asp:ImageButton ImageUrl="images/excel.jpg" runat="server" ID="ImageButton1" OnClick="ImageButton1_Click"  /></td>
            </tr>
    </table>
