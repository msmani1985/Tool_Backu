<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JobTrackLaunch.aspx.cs" Inherits="JobTrackLaunch" %>
...
<body>
    ...
    <div>
        ...
        <br />
        <table style="border:1px solid green;align:right;" align="right" >
        <tr>
            <td colspan="10" ><b>
                <asp:ImageButton id="cmd_Excel" tabIndex="41"  runat="server" ImageUrl="~/images/tools/j_excel.png" 
                ToolTip="Job Track" OnClick="cmd_Excel_Click"></asp:ImageButton>&nbsp; &nbsp; 
                <asp:ImageButton ImageUrl="images/excel.jpg" runat="server" ID="exportExcel" ToolTip="Summary" 
        ...
        <table style="border:1px solid green;align:center;" align="center" >
            <tr>
                <td colspan="10" ><b>
                    <asp:Label ID="lblPagesCount" runat="server"></asp:Label></b>
                </td>
            </tr>
        </table>
        <table style="border:1px solid green;align:center;" align="center" >
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField SortExpression="Rec_Date" HeaderText="RecDate" >
                            <ItemTemplate>
                                <asp:Label ID="lblgvRecDate" runat="server" Text='<%# Eval("Rec_Date") %>'></asp:Label>
                            </ItemTemplate>
                            <HeaderStyle HorizontalAlign="Center" />
                        </asp:TemplateField>
                       ...
                       <asp:TemplateField SortExpression="Software" HeaderText="Software">
                            <ItemTemplate>
                                <asp:Label ID="lblgvSoftware" Width="80" runat="server" Text='<%# Eval("Soft") %>'></asp:Label>
                            </ItemTemplate>
                            <HeaderStyle Width="50px" Wrap="False" HorizontalAlign="Center"/>
                        </asp:TemplateField>
                    </Columns>
