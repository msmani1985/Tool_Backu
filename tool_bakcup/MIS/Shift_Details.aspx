<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Shift_Details.aspx.cs" Inherits="Shift_Details" %>
    ...
    <br />
        ...
        <tr>
                ...
                <td>
                    ...
                    <img style="cursor:pointer; border: none" alt="Calendar" onclick="javascript:calendar_window=window.open('calendar5.aspx?formname=FromTxt','calendar_window','width=180,height=170,left=450,top=360,toolbars=no,scrollbars=no,status=no,resizable=no');calendar_window.focus()" src="images/Calendar.jpg" height="20px" border="0" />
                </td>
                <td >
                </td>
                <td>
