<%@ page language="C#" autoeventwireup="true" CodeFile="calendar2.aspx.cs" inherits="calendar2" %>
                ...
                <tr>
                    <td colspan="2" style="width: 100px">
                        <asp:Calendar Font-Size="9pt" SelectionMode="Day" DayNameFormat="FirstTwoLetters"
                            ...
                            BorderColor="green" ID="calDate" OnSelectionChanged="Change_Date" runat="server" ondayrender="Calendar1_DayRender"
                            Width="166px">
