<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Calendar3.aspx.cs" Inherits="Calendar3" %>
...
<head id="Head1" runat="server">
    ...
    function resizeWin(){
    var win=navigator.userAgent;if(win.indexOf('Firefox')!=-1)window.resizeTo(190, 260);else if(win.indexOf('Chrome')!=-1)window.resizeTo(190, 240);
                ...
                <tr>
                    <td colspan="2" style="width: 100px">
                        <asp:Calendar Font-Size="9pt" SelectionMode="Day" DayNameFormat="FirstTwoLetters"
                            ...
                            TitleStyle-BackColor="green" NextPrevStyle-Font-Bold="true" NextPrevStyle-ForeColor="white" ondayrender="Calendar1_DayRender"
