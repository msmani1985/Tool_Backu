<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Lead_EmailPreview.aspx.cs" Inherits="Lead_EmailPreview" ValidateRequest="false" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Lead FollowUp Email Preview</title>
             ...
             <table >
                <tr>
                    <td>
                        ...
                        <tr>
                            <td colspan="3" style="text-indent:5px; background:green;color:White;font-weight:bold;height:30px;vertical-align:middle; ">Lead Email Preview</td>
                        </tr>
                        <tr>
                            <td><b>Language:</b></td>
                            <td>
                                <asp:DropDownList ID="droplang" runat="server" OnSelectedIndexChanged="droplang_SelectedIndexChanged" AutoPostBack="true">
                        ...
                        <tr>
                            <td><b>From: </b></td><td><asp:label ID="lblFromAddress" runat="server" Text="sanches@datapage.org"></asp:label></td>
                        ...
                        <tr><td><b>CC: </b></td>
                            ...
                            <td colspan="3" visible="false"><asp:LinkButton ID="HlnkloadFile" Text="View Attachment1" runat="server"  OnClick="HlnkloadFile_Click"></asp:LinkButton>
