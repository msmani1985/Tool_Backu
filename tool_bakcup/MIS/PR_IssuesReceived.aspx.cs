...
public partial class PR_IssuesReceived : System.Web.UI.Page
{
    ...
    private void LoadRecords(int intMode)
    {
        ...
        try
        {
            ...
            dsProductionReport = ibSql.GetIssueReceived(intMode, strStartDate, strEndDate, strCustomer, strOpt, strInHouse);
    ...
    protected void btnExcel_Click(object sender, EventArgs e)
    {
        ...
        {
            ibSql = new datasourceIBSQL();
            string strDownloadPath = ibSql.GetDownloadPath(grdProductionReport, "Issue Received");
