<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Employee Upload.aspx.cs" Inherits="Employee_Upload" EnableEventValidation="false"  %>
...
<head runat="server">
 ...
 <script type="text/javascript">
     ...
     function NewimgBD_editor_onclick() {
         if (document.form1.hfgvempid.value != "")
             window.open("Angularjsuploadimages.aspx?trgname=" + document.form.hfgvempid.value, "Contacts", "width=800,height=600,status=yes, scrollbars=yes");
         else alert("Select a Employee");
     }
    </script>
    <script type = "text/javascript">
                    ...
                    <td>
                        <ol id="toc">
                             <li id="miSummaryDetails" runat="server">
                                <asp:LinkButton ID="LinkSummary" TabIndex = "1" runat="server" OnClick="lnkSummaryDetails_Click"  >Summary</asp:LinkButton></li>
                            <li id="miEmpDetails" runat="server">
                                <asp:LinkButton ID="lnkEmpDetails" TabIndex = "2" runat="server" OnClick="lnkEmpDetails_Click"  >Employee Details</asp:LinkButton></li>
                            <li id="miPersonalDetails" runat="server">
                                <asp:LinkButton ID="lnkPersonalDetails" TabIndex = "3" runat="server" OnClick="lnkPersonalDetails_Click"  >Personal Details</asp:LinkButton></li>
                            ...
                            <li id="miManualLeave" runat="server">
                                <asp:LinkButton ID="lnkManualLeave" TabIndex = "5" runat="server"   OnClick="lnkManualLeave_Click"  >Manual Leave correction</asp:LinkButton></li>
                            <li id="miFeedbackDetails" runat="server">
                                <asp:LinkButton ID="lnkFeedbackDetails" TabIndex = "6" runat="server" OnClick="lnkFeedbackDetails_Click"  >Feedback Details</asp:LinkButton></li>
                            <li id="miDocuments" runat="server">
                                <asp:LinkButton ID="lnkDocuments" TabIndex = "7" runat="server" OnClick="lnkDocuments_Click"  >Documents</asp:LinkButton></li>
                        </ol>
                        ...
                        <div class="borderdiv" id="div_employee_details" runat="server" style="text-align:center;width:900px;" >
                            <table id="editemployee" style="width:100%;text-align:left;">
                                <tr>
                                    <td class="dpGreenHeader" align="center" colspan="5" style="height: 30px">Employees Details
                                    </td>
                                </tr>
                                <tr>
                                    <td>Emp ID</td>
                                    ...
                                    <td rowspan="6" colspan="2" align="center">
                                        <asp:Image ID="imgPhoto" runat="server" Width="126px"  Height="126px" /> 
                                    </td>
                                </tr>
                                ...
                                <tr><td><strong>T&C</strong></td>
                                    <td>
                                        <asp:ImageButton ID="btnImg" runat="server" OnClick="btnImg_Click" /></td>
                                <td colspan="2">
                                    <asp:FileUpload ID="FileUpload1" runat="server" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <asp:Button ID="Button2"  CssClass="dpbutton" runat="server" Text="Upload" OnClick="btnUpload_Click" />&nbsp;
                                </td></tr>
                    ...
                    <FooterTemplate>
                      ...
                      <asp:Button ID="btnAddRecord" runat="server" Text="Add" CssClass="dpbutton" CommandName="Add"></asp:Button>
                        ...
                        <div class="borderdiv1" id="div_LeaveCorrection" runat="server" style="width:900px;" >
                            <div class="dptitle"> Leave ApplicationApplication</div>
                            <br />
                        ...
                        <div class="borderdiv" id="div_FeedBack_details" runat="server" style="text-align:center;width:900px;" >
                            <table id="editemployee" style="width:100%;text-align:left;" border="1">
                                ...
                                <tr>
                                 ...
                                 <tr>
                                    <td  colspan="4" align="center">
                                        <asp:GridView ID="gvFeedback" runat="server" AutoGenerateColumns="False"  Font-Size="8pt"  AllowPaging="true"
                                             OnPageIndexChanging="gvFeedback_PageIndexChanging" PageSize="10"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField SortExpression="Created_Date" HeaderText="Created Date"  >
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblgvDate" runat="server" Text='<%# Eval("Creation_Date") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                        </asp:GridView>
                        ...
                        <div class="borderdiv" id="div_documents" runat="server" style="text-align:center;width:900px;" >
                            <table id="documentst" style="width:100%;text-align:left;" border="1">
                                <tr class="dpJobGreenHeader">
                                    <td align="left" style="width: 750px"><asp:Label ID="Label5" runat="server" Text="Documents Details"></asp:Label></td>
                                    <td align="right">
                                        <asp:ImageButton ID="ImageButton1" runat="server" src="images/upload.png" Width="30" Height="30" OnClick="ImageButton1_Click" />
                                        <asp:ImageButton ID="ImageButton2" runat="server" src="images/Refresh.png" Width="30" Height="30" OnClick="ImageButton2_Click" />
                                    </td>
                                </tr>
                                <tr>
                                    <td align="center" colspan="2">
                                         <asp:GridView ID="grdDoc" runat="server"  AutoGenerateColumns="false"
                                               EmptyDataText="No data available." Font-Size="8pt"  AllowPaging="true" OnPageIndexChanging="grdDoc_PageIndexChanging"
                                               PageSize="7" OnRowCommand="grdDoc_RowCommand">
                                                <HeaderStyle CssClass="GVFixedHeader" />
                                                <AlternatingRowStyle BackColor="#F2F2F2" />
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="FileNames" HeaderText="File Name" SortExpression="Date"  ItemStyle-HorizontalAlign="Center" />
                                                     <asp:TemplateField SortExpression="Download" HeaderText="Download"  ItemStyle-HorizontalAlign="Center">
                                                         <ItemTemplate>
                                                                <asp:ImageButton ID="lblFolderpath" src="images/Download.png" CommandName="Document" Width="30" Height="30" runat="server"></asp:ImageButton>
                                                                <asp:Label ID="lblpath" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container.DataItem,"Folderpath") %>'></asp:Label>
                                                         </ItemTemplate>
                                                     </asp:TemplateField>
                                                    <asp:BoundField DataField="CreatedDate" HeaderText="Uploaded Date" SortExpression="Date"  ItemStyle-HorizontalAlign="Center" />
                                                </Columns>
                                          </asp:GridView>
                                    </td>
                                </tr>
