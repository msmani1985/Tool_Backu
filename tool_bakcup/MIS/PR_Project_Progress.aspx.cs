...
public partial class PR_Project_Progress : System.Web.UI.Page
{
    ...
    private void LoadRecords(int intMode)
    {
        ...
        try
        {
            ...
            dsProductionReport = ibSql.GetProductionReportProjectProgress(intMode, strStartDate, strEndDate, strCustomer);
