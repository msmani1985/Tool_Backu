<%@ Page Language="C#" AutoEventWireup="true" CodeFile="invoiceablejobs.aspx.cs" Inherits="invoiceablejobs" EnableEventValidation="false" %>
...
<body>
    ...
    AllowSorting="True" width="97%" runat="server" AutoGenerateColumns="False"
		...
		<Columns>
			...
			<asp:TemplateField HeaderText="">
				...
				<a target="_blank" style="border:none"  href="previewinvoice.aspx?location=i&category=1&type=pdf&issueno=<%# DataBinder.Eval(Container.DataItem, "IISSUENO").ToString().Trim()%>&custno=<%# DataBinder.Eval(Container.DataItem, "CNO").ToString().Trim()%>&jourcode=<%# DataBinder.Eval(Container.DataItem, "JOURCODE").ToString().Trim()%>&journo=<%# DataBinder.Eval(Container.DataItem, "JOURNO").ToString().Trim()%>&ino=<%# DataBinder.Eval(Container.DataItem, "INO").ToString().Trim()%>&invoiceno=<%# DataBinder.Eval(Container.DataItem,"IINNO") %>">
			...
			<asp:TemplateField HeaderText="">
				...
				<a target="_blank" style="border:none"  title="Click Here to Preview Dublin format" href="previewinvoice.aspx?location=d&category=1&type=pdf&issueno=<%# DataBinder.Eval(Container.DataItem, "IISSUENO").ToString().Trim()%>&custno=<%# DataBinder.Eval(Container.DataItem, "CNO").ToString().Trim()%>&jourcode=<%# DataBinder.Eval(Container.DataItem, "JOURCODE").ToString().Trim()%>&journo=<%# DataBinder.Eval(Container.DataItem, "JOURNO").ToString().Trim()%>&ino=<%# DataBinder.Eval(Container.DataItem, "INO").ToString().Trim()%>&invoiceno=<%# DataBinder.Eval(Container.DataItem,"IINNO") %>">
			...
			<asp:TemplateField HeaderText="XML view">
				<ItemTemplate>
				<a target="_blank" style="border:none"  title="Click Here to Preview Dublin format" href="previewinvoice.aspx?location=d&category=1&type=xml&iinvoiceno=<%# DataBinder.Eval(Container.DataItem,"IINNO") %>&issueno=<%# DataBinder.Eval(Container.DataItem, "IISSUENO").ToString().Trim()%>&custno=<%# DataBinder.Eval(Container.DataItem, "CNO").ToString().Trim()%>&jourcode=<%# DataBinder.Eval(Container.DataItem, "JOURCODE").ToString().Trim()%>&journo=<%# DataBinder.Eval(Container.DataItem, "JOURNO").ToString().Trim()%>&ino=<%# DataBinder.Eval(Container.DataItem, "INO").ToString().Trim()%>&invoiceno=<%# DataBinder.Eval(Container.DataItem,"IINNO") %>">
				    <img alt="Click to View XML Invoice" onclick="javascript:changeGreenImage(this);" id="SecondImg1" runat="server" style="cursor:pointer; border:none " src="images/crystal-xml.png" height="28"  />
			    </a>
				    <%--<a target="_blank" id="secondanchor" title="Click to Email Invoice" href="emailpreview.aspx?location=d&category=1&iinvoiceno=<%# DataBinder.Eval(Container.DataItem,"IINNO") %>&issueno=<%# DataBinder.Eval(Container.DataItem, "IISSUENO").ToString().Trim()%>&custno=<%# DataBinder.Eval(Container.DataItem, "CNO").ToString().Trim()%>&jourcode=<%# DataBinder.Eval(Container.DataItem, "JOURCODE").ToString().Trim()%>&journo=<%# DataBinder.Eval(Container.DataItem, "JOURNO").ToString().Trim()%>&ino=<%# DataBinder.Eval(Container.DataItem, "INO").ToString().Trim()%>&pemail=<%# DataBinder.Eval(Container.DataItem, "INEMAIL").ToString().Trim()%>&pename=<%# DataBinder.Eval(Container.DataItem, "INVDNAME").ToString().Trim()%>&Mailflg=2&finsiteno=<%# DataBinder.Eval(Container.DataItem,"FINNO")%>">				
					    <img id="SecondImg1" style="cursor:pointer;border:none " runat="server" src="images/crystal-xml.png" height="25" alt="T&F Common Email" title="T&F Common Email" />
					</a>--%>
				</ItemTemplate>
			</asp:TemplateField>
    ...
    &nbsp;&nbsp;
        ...
        <FooterStyle CssClass="GVFixedFooter" />         
            <Columns>
                ...
                <asp:TemplateField HeaderText="Dispatch Date" SortExpression="BDISPATCH1">
                    <ItemTemplate>
                        <%# DataBinder.Eval(Container.DataItem, "BDISPATCH1").ToString()%>
                    </ItemTemplate>
                </asp:TemplateField>                
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="">
				<ItemTemplate>
				<a target="_blank" style="border:none"  href="previewinvoice.aspx?location=i&category=4&custno=<%# DataBinder.Eval(Container.DataItem,"WCUSTNO") %>&conno=<%# DataBinder.Eval(Container.DataItem,"CONNO") %>&invno=<%# DataBinder.Eval(Container.DataItem,"INVNO") %>&pename=<%# DataBinder.Eval(Container.DataItem,"INVDNAME") %>&jourcode=<%# DataBinder.Eval(Container.DataItem,"JOURCODE") %>">
			...
			<asp:TemplateField HeaderText="">
				...
				<a target="_blank" style="border:none"  title="Click Here to Preview Dublin format" href="previewinvoice.aspx?location=d&category=4&custno=<%# DataBinder.Eval(Container.DataItem,"WCUSTNO") %>&conno=<%# DataBinder.Eval(Container.DataItem,"CONNO") %>&invno=<%# DataBinder.Eval(Container.DataItem,"INVNO") %>&pename=<%# DataBinder.Eval(Container.DataItem,"INVDNAME") %>&jourcode=<%# DataBinder.Eval(Container.DataItem,"JOURCODE") %>">
			...
			<asp:TemplateField HeaderText="XML view">
				<ItemTemplate>
				<a target="_blank" style="border:none"  title="Click Here to Preview Dublin format" href="previewinvoice.aspx?location=d&category=4&type=xml&custno=<%# DataBinder.Eval(Container.DataItem,"WCUSTNO") %>&conno=<%# DataBinder.Eval(Container.DataItem,"CONNO") %>&invno=<%# DataBinder.Eval(Container.DataItem,"INVNO") %>&pename=<%# DataBinder.Eval(Container.DataItem,"INVDNAME") %>">
				    <img alt="Click to View XML Invoice" onclick="javascript:changeGreenImage(this);" id="SecondImg1" runat="server" style="cursor:pointer; border:none " src="images/crystal-xml.png" height="28"  />
			    </a>
				    <%--<a target="_blank" id="secondanchor" title="Click to Email Invoice" href="emailpreview.aspx?location=d&category=1&iinvoiceno=<%# DataBinder.Eval(Container.DataItem,"IINNO") %>&issueno=<%# DataBinder.Eval(Container.DataItem, "IISSUENO").ToString().Trim()%>&custno=<%# DataBinder.Eval(Container.DataItem, "CNO").ToString().Trim()%>&jourcode=<%# DataBinder.Eval(Container.DataItem, "JOURCODE").ToString().Trim()%>&journo=<%# DataBinder.Eval(Container.DataItem, "JOURNO").ToString().Trim()%>&ino=<%# DataBinder.Eval(Container.DataItem, "INO").ToString().Trim()%>&pemail=<%# DataBinder.Eval(Container.DataItem, "INEMAIL").ToString().Trim()%>&pename=<%# DataBinder.Eval(Container.DataItem, "INVDNAME").ToString().Trim()%>&Mailflg=2&finsiteno=<%# DataBinder.Eval(Container.DataItem,"FINNO")%>">				
					    <img id="SecondImg1" style="cursor:pointer;border:none " runat="server" src="images/crystal-xml.png" height="25" alt="T&F Common Email" title="T&F Common Email" />
			...
			<asp:TemplateField HeaderText="EVNO">
            	...
            	<asp:TemplateField HeaderText="JOURCODE">
			    <ItemTemplate>
			            <%# DataBinder.Eval(Container.DataItem, "JOURCODE")%>
			    </ItemTemplate>
			</asp:TemplateField>
