...
public partial class PR_ArticleDue : System.Web.UI.Page
{
    ...
    private void LoadRecords(int intMode)
    {
        ...
        try
        {
            ...
            dsProductionReport = ibSql.GetProductionReportArticleDue(intMode, strStartDate, strEndDate, strCountry, strCustomer);
    ...
    protected void btnExcel_Click(object sender, EventArgs e)
    {
        ...
        {
            ibSql = new datasourceIBSQL();
            string strDownloadPath = ibSql.GetDownloadPath(grdProductionReport, "Article Due");
