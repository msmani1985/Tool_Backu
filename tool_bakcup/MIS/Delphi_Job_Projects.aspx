<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Delphi_Job_Projects.aspx.cs" Inherits="Delphi_Job_Projects" %>
...
<body>
                ...
                <tr>
                    <td>
                        <ol id="toc">
                            ...
                            <li id="miProjectListUpload" runat="server">
                                <asp:LinkButton ID="lnkProjectListUpload" runat="server" TabIndex="10" onclick="lnkProjectLinkUpload_Click" 
                                   >Article List</asp:LinkButton></li>
                        </ol>
                                ...
                                <table id="XMLTAGS" border="0" width="100%" cellpadding="2" cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <asp:ListItem Text="PROJECTS" Value="0"></asp:ListItem>
                                            <asp:ListItem Text="EP" Value="1"></asp:ListItem>
                                            </asp:DropDownList>
                                            </td>
                                    </tr>
                                    <tr>
                        ...
                        <div class="content" id="tabProjectListUpload" runat="server">
                        <table width="100%" cellpadding="2" cellspacing="0">
                                <tr>
                                    <td colspan="4" class="dpJobGreenHeader" style="width: 839px">
                                        <img id="Img3" align="absmiddle" src="images/tools/events.png" runat="server" />
                                        <asp:Label ID="Label6" runat="server" Text="Article List"></asp:Label>
                                        </td>
                                    <td class="dpJobGreenHeader">
                                ...
                                <center>
                                    ...
                                    <asp:GridView ID="gvExcelFile" runat="server" AutoGenerateColumns="False" CssClass="lightbackground"
                                    OnRowCommand="gvExcelFile_RowCommand" >
                                                
                                        <Columns>
                                            <asp:TemplateField HeaderText="Sl.No">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblSlNo" runat="server"
                                                        Text='<%# DataBinder.Eval(Container.DataItem,"SlNo") %>' Width="80px"></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Journal ID">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblJourID" runat="server"
                                                        Text='<%# DataBinder.Eval(Container.DataItem,"ArticleID") %>' Width="80px"></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Pages">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="lblPages" runat="server"
                                                        Text='<%# DataBinder.Eval(Container.DataItem,"Pages") %>' Width="80px"></asp:TextBox>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Received Date">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtRecDate" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"RECEIVED") %>' CssClass="RECV" ReadOnly="FALSE" 
                                                        Width="80px"></asp:TextBox>
                 <ajaxToolkit:CalendarExtender TargetControlID="txtRecDate"  PopupButtonID="txtRecDate" Format="MM/dd/yyyy"  ID="CalendarExtender2" runat="server" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Due Date">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtDueDate" Text='<%# DataBinder.Eval(Container.DataItem,"DUE") %>' runat="server" CssClass="DUE" ReadOnly="FALSE" 
                                                        Width="80px"></asp:TextBox>
                <ajaxToolkit:CalendarExtender TargetControlID="txtDueDate"  PopupButtonID="txtDueDate" Format="MM/dd/yyyy"  ID="CalendarExtender1" runat="server" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Task">
                                                <ItemTemplate>
                                                    <asp:DropDownList ID="drpTask" SelectedValue='<%# DataBinder.Eval(Container.DataItem,"TASK") %>'  runat="server" CssClass="TSK" Width="80px">
                                            ...
                                            <asp:TemplateField HeaderText="Fill all">
                                                <HeaderTemplate>
                                                    <asp:LinkButton ID="fillSelectAll" runat="server" 
                                                        OnClick="chkboxSelectAll_CheckedChanged">Fill All</asp:LinkButton><br />
                                                ...
                                                <ItemTemplate>
                                                      <input ID="chkFillAll" runat="server" class="FILL" type="checkbox"> </input>
                                                       <asp:ImageButton ID="BtnReject" CommandName="imgdelete" ToolTip="Delete" AlternateText="Reject" ImageUrl="~/images/tools/no.png" 
                        runat="server" /> 
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                    ...
                                    <asp:Button CssClass="dpbutton" ID="saveArticle" runat="server" 
                                        Text="Save" onclick="saveArticle_Click"  />
                                    </center>
    ...
    <script type="text/javascript">
        ...
        function gridviewScroll() {
                 $('#<%=gvExcelFile.ClientID%>').gridviewScroll({
