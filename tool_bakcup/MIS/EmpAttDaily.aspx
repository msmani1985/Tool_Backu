<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EmpAttDaily.aspx.cs" Inherits="EmpAttDaily" %>
                                    ...
                                    <asp:GridView ID="grvrpt" runat="server"  CaptionAlign="Left"
                                        ...
                                        <alternatingrowstyle backcolor="#F0FFF0"/>
                                         <Columns>
                                            ...
                                            <asp:boundfield datafield="Punch1"   headertext="Punch1"/>
                                            <asp:boundfield datafield="Punch2"   headertext="Punch2"/>
                                            <asp:boundfield datafield="Punch3"   headertext="Punch3"/>
                                            <asp:boundfield datafield="Punch4"   headertext="Punch4"/>
                                            <asp:boundfield datafield="Punch5"   headertext="Punch5"/>
                                            <asp:boundfield datafield="Punch6"   headertext="Punch6"/>
                                            <asp:boundfield datafield="Punch7"   headertext="Punch7"/>
                                            <asp:boundfield datafield="Punch8"   headertext="Punch8"/>
                                            <asp:boundfield datafield="Punch9"   headertext="Punch9"/>
                                            <asp:boundfield datafield="Punch10"   headertext="Punch10"/>
                                            <asp:boundfield datafield="Punch11"   headertext="Punch11"/>
                                            <asp:boundfield datafield="Punch12"   headertext="Punch12"/>
                                        </Columns>
