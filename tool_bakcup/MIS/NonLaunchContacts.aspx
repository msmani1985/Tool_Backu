<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NonLaunchContacts.aspx.cs" Inherits="NonLaunchContacts" %>
    ...
    <form id="form1" runat="server">
            ...
            <table align="center" cellpadding="1" cellspacing="1" class="bordertable" width="750">
                <tr>
                    <td colspan="6" valign="top">
                        Customer: &nbsp;<asp:DropDownList ID="drpCustomerSearch" runat="server" Width="262px">
                        </asp:DropDownList>&nbsp;&nbsp;
                         Location: &nbsp;<asp:DropDownList ID="drpLocationSearch" runat="server" Width="262px">
                        </asp:DropDownList>
                        </td>
                </tr>
                <tr>
                            ...
                            <Columns>
                                <asp:TemplateColumn HeaderText="Sno.">
                                    <ItemTemplate>
                                        ...
                                        <asp:HiddenField ID="hfContactID" runat="server" Value='<%# Eval("conno") %>' />
                                    </ItemTemplate>
                                </asp:TemplateColumn>
                                <asp:TemplateColumn HeaderText="Name">
                                    <ItemTemplate>
                                        <asp:Label ID="lblContactDispName" runat="server" Text='<%# Eval("INVDISPLAYNAME") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateColumn>
                                <asp:TemplateColumn HeaderText="Email">
                                    <ItemTemplate>
                                        <asp:Label ID="lblContactEmail1" runat="server" Text='<%# Eval("INVCONEMAIL") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateColumn>
                                <asp:TemplateColumn>
                                    <ItemTemplate>
        ...
        <div id="tabMaster" runat="server">
            ...
            <table align="center" cellpadding="1" cellspacing="1" class="bordertable" width="650">
                ...
                <tr>
                    <td style="width: 120px">
                        Location <span style="font-size: 9pt; color: #ff0000">*</span></td>
                    <td style="width: 12px">
                        :</td>
                    <td colspan="4">
