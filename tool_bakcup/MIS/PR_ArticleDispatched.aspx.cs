...
public partial class PR_ArticleDispatched : System.Web.UI.Page
{
    ...
    private void LoadRecords(int intMode)
    {
        ...
        try
        {
            ...
            dsProductionReport = ibSql.GetProductionReportDespatched(intMode, strStartDate, strEndDate, strCustomer);
    ...
    protected void btnExcel_Click(object sender, EventArgs e)
    {
        ...
        {
            ibSql = new datasourceIBSQL();
            string strDownloadPath = ibSql.GetDownloadPath(grdProductionReport, "Article Despatched");
