<%@ Page Language="C#" AutoEventWireup="true" CodeFile="jobbag.aspx.cs" Inherits="jobbag" EnableEventValidation="false" %>
                                        ...
                                        <div id="jobhisdetails" >
                                            <asp:GridView width="550px"  ID="jobhistroygv" runat="Server" AutoGenerateColumns="false" HeaderStyle-CssClass="darkbackground" >
                                                <Columns>
                                                    ...
                                                    <asp:BoundField HeaderText="Received" DataField="RECEIVE_DATE" DataFormatString="{0:MM/dd/yyyy}" HtmlEncode="false" />
                                                    <asp:BoundField HeaderText="Due" DataField="due_date" DataFormatString="{0:MM/dd/yyyy}" HtmlEncode="false"  />
                                                    <asp:BoundField HeaderText="Half Due" DataField="HALFDUE_DATE" DataFormatString="{0:MM/dd/yyyy}" HtmlEncode="false" />
                                ...
                                <tr>
                                    <td><div id="onholddetails" >
                                            <asp:GridView ID="onholdgv" Width="550px" runat="server" HeaderStyle-CssClass="darkbackground" AutoGenerateColumns="false">
                                                <Columns>
                                                    <asp:BoundField HeaderText="Name" DataField="stypename" />
                                             ...
                                             OnRowDataBound="ondatabound">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Job Name">
                                                        <ItemTemplate><a id="a_jobname" runat="server" href='<%# "jobbag.aspx?jobid=" + Eval("job_id") + "&jobtypeid=" + Eval("job_type_id") %>'><%# DataBinder.Eval(Container.DataItem,"name") %></a> </ItemTemplate>
                                                    </asp:TemplateField>
