...
/// </summary>
 * */
public partial class sales_publisher_summary : System.Web.UI.Page
{
    protected int id = 1;
    ...
    protected void btnSubmit_Click(object sender, EventArgs e){
        ...
        gvPubSummary.DataSource = oSales.getPublishersSummary(drpCountry.SelectedItem.Value.Trim());
