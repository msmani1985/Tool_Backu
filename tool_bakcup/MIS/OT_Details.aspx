<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OT_Details.aspx.cs" Inherits="OT_Details" %>
...
<body>
    ...
    <br />
        <table align="center" class="bordertable" width="850px" cellpadding="2" cellspacing="5">
            <tr>
                <td>
                    Emp Code 
                </td>
            ...
            <tr>
                ...
                <td colspan="5">
                    ...
                    <img style="cursor:pointer; border: none" alt="Calendar" onclick="javascript:calendar_window=window.open('calendar5.aspx?formname=FromTxt','calendar_window','width=180,height=170,left=450,top=360');calendar_window.focus()" src="images/Calendar.jpg" height="20px" border="0" />&nbsp;
                    ...
                    &nbsp;
                     ...
                     <asp:Label ID="ActOT" runat="server" Text="Actual Time:"></asp:Label>&nbsp;
                     <asp:Label ID="txtActOT" runat="server" Width="70"></asp:Label>&nbsp;
                </td>
