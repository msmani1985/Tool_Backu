...
public partial class ProdInfoJL : System.Web.UI.Page
{
    ...
    protected void ddlCategory_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        ddlJournalName.Items.Insert(0, new ListItem("-- select --", "0"));
        ...
        ddlJourCode.Items.Insert(0, new ListItem("-- select --", "0"));
    ...
    protected void ddlJournalName_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        if(Convert.ToInt32(ddlJournalName.SelectedValue) !=0 )
        {
            ...
            if (Convert.ToInt32(ds.Tables[0].Rows[0]["ISFPM"]) == 0)
                ddlFPM.SelectedValue = "0";
            else
                ddlFPM.SelectedValue = "1";

            if (Convert.ToInt32(ds.Tables[0].Rows[0]["ISSAM"]) == 0)
                ddlSAM.SelectedValue = "0";
            else
                ddlSAM.SelectedValue = "1";
            ...
            if (Convert.ToInt32(ds.Tables[0].Rows[0]["ISCOPYEDIT"]) == 0)
                ddlCopyedit.SelectedValue = "0";
            else
                ddlCopyedit.SelectedValue = "1";
            lblFolderpath.Text = ds.Tables[0].Rows[0]["Journal_folder"].ToString();
            txtPDFQCValue.Text = ds.Tables[0].Rows[0]["PDFQCValue"].ToString();
            txtVendorMgtValue.Text = ds.Tables[0].Rows[0]["VendorMgtValue"].ToString();
            txtCustService.Text = ds.Tables[0].Rows[0]["CustService"].ToString();
    ...
    protected void ddlJourCode_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        if (Convert.ToInt32(ddlJourCode.SelectedValue) != 0)
        {
            ...
            txtProdEds.Text = ds.Tables[0].Rows[0]["pemail"].ToString();
            txtComments.Text = ds.Tables[0].Rows[0]["jcomments"].ToString();
            txtSAMPriceCode.Text = ds.Tables[0].Rows[0]["copyedit_pcode"].ToString();
            txtCreatedOn.Text = ds.Tables[0].Rows[0]["jourcreationdate"].ToString();
            txtIssnOnline.Text = ds.Tables[0].Rows[0]["jouronlineissn"].ToString();
            txtIssnPrint.Text = ds.Tables[0].Rows[0]["jourissn"].ToString();
            txtVolNo.Text = ds.Tables[0].Rows[0]["volno"].ToString();
        ...
        */
        if(btnSubmit.Text=="Update")
        {
            string[,] sJournalupdate ={
                                    ...
                                    {"@jcomments", txtComments.Text},{"@psno",ddlPageStarts.SelectedValue.Trim()},{"@pagetrimno", ddlTrimSize.SelectedValue.Trim()},
                                    ...
                                    {"@custno",ddlAccount.SelectedValue.Trim()},{"@issam",ddlSAM.SelectedValue.Trim()},{"@isfpm",ddlFPM.SelectedValue.Trim()},{"@modifiedby",Convert.ToInt32(Session["employeeid"]).ToString()},{"@iscopyedit",ddlCopyedit.SelectedValue.Trim()}, {"@PDFQCValue",txtPDFQCValue.Text.Trim()},{"@VendorMgtValue",txtVendorMgtValue.Text.Trim()},{"@CustService",txtCustService.Text.Trim()} };
            //sds = objCom.ExcProcedurePrdJL("spUpdate_Journal", sJournalupdate, CommandType.StoredProcedure);
            sds = objCom.ProductivityDetailsGrid("spUpdate_Journal", sJournalupdate);
        ...
        else if(btnSubmit.Text=="Add")
        {
            ...
            {
                 lblError.Text="Please select TAT";
            }
            else if (ddlUrgentTat.SelectedValue == "0")
            {
                 lblError.Text="Please select Urgent TAT";
            }
            else if (ddlIssueTAT.SelectedValue == "0")
            {
                 lblError.Text="Please select Issue TAT";
            }
            else
            {
                string[,] sJournalInset ={{"@journame",txtJournalName.Text},{"@jourcode",txtJourCode.Text},{"@typestyleno",ddlJourStyle.SelectedValue.Trim()},
                                 ...
                                 {"@catno",ddlDataformat.SelectedValue.Trim()},{"@jourschdays",ddlTAT.SelectedValue.Trim()},{"@jcno",txtPriceCode.Text.Trim()},
                                 {"@issensitive",ddlSensitiveJournal.SelectedValue.Trim()},{"@jourschurgentdays", ddlUrgentTat.SelectedValue.Trim()},
                                 {"@jourissuedays",ddlIssueTAT.SelectedValue.Trim()},{"@custno", ddlAccount.SelectedValue.Trim()},{"@Createdby",Convert.ToInt32(Session["employeeid"]).ToString()},
                                 //{"@PDFQCValue",txtPDFQCValue.Text.Trim()},{"@VendorMgtValue",txtVendorMgtValue.Text.Trim()},{"@CustService",txtCustService.Text.Trim()}
                                 };
    ...
    {
        CleadFields();
        ddlJournalName.Visible = false;
        ddlJourCode.Visible = false;
    ...
    protected void btnSupContactDet_Click(object sender, ImageClickEventArgs e)
    {
        ...
        {
            lblError.Text="No Supervisor selected";
        }
    }
    protected void btnPmgrContactDet_Click(object sender, ImageClickEventArgs e)
    {
        ...
        {
            lblError.Text="No Production Manager selected";
        }
    }
    protected void btnPEContactDet_Click(object sender, ImageClickEventArgs e)
    {
        ...
        {
            lblError.Text="No Production Editor selected";
        }
    }
