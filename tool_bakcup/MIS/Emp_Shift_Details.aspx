<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Emp_Shift_Details.aspx.cs" Inherits="Emp_Shift_Details" %>
            ...
            <table>
                <tr>
                    <td class="auto-style1">
                        ...
                        <asp:Label ID="Label1" runat="server" Text="File Upload : " style="font-weight: 700"></asp:Label>
                        <asp:FileUpload ID="FileUpload1" runat="server" Height="16px" Width="194px" />
                        <asp:Button ID="Button1" runat="server" Text="Upload" CssClass="dpbutton" OnClick="Button1_Click"/>
                ...
                <tr>
                    <td align="center" colspan="2">
                        <asp:RadioButtonList ID="rbLocation"  Visible="false" runat="server" RepeatDirection="Horizontal" Height="22px" Width="217px" >
