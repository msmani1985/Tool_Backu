<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SGM_AuthorQueryemailpreview.aspx.cs" Inherits="SGM_AuthorQueryemailpreview"  ValidateRequest="false" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>SGM Follow Up Email Preview</title>
         ...
         <table >
            <tr>
                <td>
                    ...
                    <tr>
                        <td colspan="3" style="text-indent:5px; background:green;color:White;font-weight:bold;height:30px;vertical-align:middle; ">SGM eProof Email Preview</td>
                    </tr>
                    <tr>
                        <td><b>From: </b></td><td><asp:label ID="lblFromAddress" runat="server" Text="cwgms@charlesworth-group.com"></asp:label></td>
                    ...
                    <tr><td><b>CC: </b></td>
                        ...
                        <tr><td style="vertical-align:top;" valign="top"  colspan="3">
                            ...
                            <asp:TextBox id="lblBody" style="border:solid 1px gray;Height:266px; Width:100%;" CssClass="textbox" runat="server"></asp:TextBox>
                            </td></tr>
                    </table>
                </td>
                <td>
