<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProductionStaff.aspx.cs"  MaintainScrollPositionOnPostback="true" Inherits="ProductionStaff" %>
    ...
    <div class="borderdiv" style="text-align:left;width:900px;">
        ...
        <table style="width: 889px">
            ...
            <tr>
                ...
                <td>
                    <myp:MonthYearPicker ID="mypMonthYear" Visible="false" runat="server" PanelCss="DatePanel" MinYear="2015"
                        MaxYear="2025" MaxMonth="13" MinMonth="1" />
                </td>
                <td>
                    <asp:RadioButtonList ID="rbLocation" runat="server" Visible="false" RepeatDirection="Horizontal" Width="264px" OnSelectedIndexChanged="rbLocation_SelectedIndexChanged" AutoPostBack="true">
