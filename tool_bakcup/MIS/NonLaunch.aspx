<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NonLaunch.aspx.cs" Inherits="NonLaunch" %>
            ...
            <tr>
                <td>
                                               ...
                                               <asp:TemplateField SortExpression="File" HeaderText="No. of Files" >
                                                ...
                                                <asp:TemplateField HeaderText="WO / PO Number">
                                                 ...
                                                 <asp:TemplateField HeaderText="Stage">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblIStage" runat="server"  Text='<%# DataBinder.Eval(Container.DataItem,"IStatus") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderText="Invoice No.">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblInvno" runat="server"  Text='<%# DataBinder.Eval(Container.DataItem,"Invno") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                    ...
                    <div class="content" id="tabNonLaunch" runat="server">
                             <table id="Table5" border="0" cellpadding="2" cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        Launch ID: &nbsp;&nbsp;
                                            <asp:TextBox ID="txtLaunchID" runat="server"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="auto-style2">        
                                            ...
                                            <asp:DropDownList ID="drpType" runat="server">
                                                ...
                                                <asp:ListItem Value="1">IBM</asp:ListItem>
                                                <asp:ListItem Value="2">IBM RTE</asp:ListItem>
                                                <asp:ListItem Value="4">IBM DQA</asp:ListItem>
                            ...
                            <table >
                                <tr  class="dpJobGreenHeader">
                                    <td  style="height: 32px; background-image: url(images/green-noise-background.png);width:900px" colspan="4">
                                        ...
                                        <asp:Label ID="Label15" runat="server" Text="Project Cost"></asp:Label>
                                   </td>
                                </tr>
                            <tr>
                    ...
                    <div class="content" id="tabLoggedEvents" runat="server">
                        <table id="Table4" border="0" cellpadding="2" cellspacing="0">
                            <tr class="dpJobGreenHeader">
                                    <td  style="background-image: url('images/green-noise-background.png');" class="auto-style9">
