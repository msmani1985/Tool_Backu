<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JobReceivedReport.aspx.cs" Inherits="JobReceivedReport" %>
...
<body>
    ...
    <div>
       ...
       <%-- <asp:BoundField DataField="Work Flow" HeaderText="WORK FLOW"/>--%>
                       <asp:TemplateField>
        <HeaderTemplate>
        <asp:DropDownList OnSelectedIndexChanged="dd_workflow_OnSelectedIndexChanged" AutoPostBack="true" ID="dd_workflow" runat="server" ></asp:DropDownList>
        </HeaderTemplate>
        <ItemTemplate>
        <%# DataBinder.Eval(Container.DataItem,"[Work Flow]") %>
        </ItemTemplate>
        </asp:TemplateField>
