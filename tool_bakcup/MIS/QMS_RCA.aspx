<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QMS_RCA.aspx.cs" Inherits="QMS_RCA" %>
...
<div>
   ...
   <br />
    ...
    <div class="content" id="divReports" runat="server" visible="false">
       <table class="bordertable" style="width: 698px; height: 107px">
           <tr>
               <td align="right" style="height: 106px">
                   Start Date:</td>
               ...
               <td rowspan="1" valign="middle" style="height: 106px">
                   <asp:Button ID="BtnSubmit" runat="server" CssClass="dpbutton"
                       Text="View" OnClick="BtnSubmit_Click" /></td>
               <td rowspan="1" valign="middle">
            <asp:ImageButton ID="imgbtnEventExport" runat="server" ImageUrl="~/images/QMS/excel.png" OnClick="imgbtnEventExport_Click"
            ToolTip="Export Excel" Width="25px" /></td>
           </tr>
       </table>
       <br />
       <div style="overflow:scroll; height:410px">
       <asp:GridView ID="grvrpt" runat="server"  autogeneratecolumns="False" emptydatatext="No data available." BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3">
            <Columns>
                <asp:boundfield datafield="Upload_Id"  headertext="Id" Visible="False"/>
                <asp:boundfield datafield="Issue_ID"  headertext="Issue ID" >
                    <HeaderStyle BackColor="Yellow" Font-Names="Calibri" Font-Size="11px" ForeColor="Black" VerticalAlign="Top" HorizontalAlign="Left" />
                    <ItemStyle Font-Names="Book Antiqua" Font-Size="11px"  />
                </asp:boundfield>
                <asp:boundfield datafield="Prod_Staff"   headertext="Production Staff">
                    <HeaderStyle BackColor="Yellow" Font-Names="Calibri" Font-Size="11px" ForeColor="Black" VerticalAlign="Top"  HorizontalAlign="Left"/>
                    <ItemStyle Font-Names="Book Antiqua" Font-Size="11px" VerticalAlign="Top"  HorizontalAlign="Left" />
                </asp:boundfield>
                ...
                <asp:boundfield datafield="Problem_type"  headertext="Is the problem type accurate from supplier point of view?">
                    <HeaderStyle BackColor="LimeGreen" Font-Names="Calibri" Font-Size="11px" ForeColor="Black" VerticalAlign="Top"  HorizontalAlign="Left"/>
                    <ItemStyle Font-Names="Book Antiqua" Font-Size="11px" VerticalAlign="Top"  HorizontalAlign="Left"/>
                </asp:boundfield>
                ...
                <asp:boundfield datafield="Date_RCA"  headertext="Date RCA returned">
                    <HeaderStyle BackColor="LightSeaGreen" Font-Names="Calibri" Font-Size="11px" ForeColor="Black" VerticalAlign="Top"  HorizontalAlign="Left"/>
                    <ItemStyle Font-Names="Book Antiqua" Font-Size="11px" VerticalAlign="Top"  HorizontalAlign="Left"/>
                </asp:boundfield>
                ...
                <asp:boundfield datafield="TandF_Comments1"  headertext="(T&amp;F QM/SM comment if escalated) T&amp;F or supplier actions to resolve problem">
                    <HeaderStyle BackColor="LightSeaGreen" Font-Names="Calibri" Font-Size="11px" ForeColor="Black" VerticalAlign="Top"/>
                    <ItemStyle Font-Names="Book Antiqua" Font-Size="11px" VerticalAlign="Top"/>
                </asp:boundfield>
       ...
       <asp:GridView ID="grdview2" runat="server"  autogeneratecolumns="False" emptydatatext="No data available." BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" >
            <Columns>
                <asp:boundfield datafield="Upload_Id"  headertext="Id" Visible="False"/>
                <asp:boundfield datafield="Issue_ID"  headertext="Issue ID" >
                    <HeaderStyle BackColor="Yellow" Font-Names="Calibri" Font-Size="11px" ForeColor="Black" VerticalAlign="Top" HorizontalAlign="Left" />
                ...
                <asp:boundfield datafield="Assign_category"  headertext="Re-categorized problem type, if not correct?">
                    <HeaderStyle BackColor="LimeGreen" Font-Names="Calibri" Font-Size="11px" ForeColor="Black" VerticalAlign="Top"  HorizontalAlign="Left"/>
                    <ItemStyle Font-Names="Book Antiqua" Font-Size="11px" VerticalAlign="Top"  HorizontalAlign="Left"/>
                </asp:boundfield>
                <asp:boundfield datafield="Multiple_category"   headertext="Specify here for multiple categories or further details e.g. CE - text syle; CE - ref style">
                ...
                <asp:boundfield datafield="FollowUp"  headertext="Is T&f follow-up action required?">
                    <HeaderStyle BackColor="LimeGreen" Font-Names="Calibri" Font-Size="11px" ForeColor="Black" VerticalAlign="Top"  HorizontalAlign="Left"/>
                    <ItemStyle Font-Names="Book Antiqua" Font-Size="11px" VerticalAlign="Top"  HorizontalAlign="Left"/>
                </asp:boundfield>
 ...
 <asp:GridView ID="gvCustomerList" runat="server" OnPageIndexChanging="gvCustomerList_PageIndexChanging"   autogeneratecolumns="false" 
        ...
        pagesize="15" OnRowDataBound="gvCustomerList_RowDataBound" OnRowCommand="gvCustomerList_RowCommand"  DataKeyNames="Upload_Id" OnSelectedIndexChanged="gvCustomerList_SelectedIndexChanged">
...
<tr>
    <td style="text-align: center;">
        <table align="center" border="0" cellpadding="5" cellspacing="2" >
         <tr>
                                    <td colspan="4" class="dpJobGreenHeader" style=" height: 9px;">
            ...
            <tr>
                ...
                <td class="tdstyle" align="left" style=" height: 55px; ">
                ...
                <td class="tdstyle" align="left" style=" height: 54px;">
...
<table id="tblResponce" runat="server" border="0" cellpadding="5" cellspacing="2" class="boxTable">
    ...
    <tr>
        ...
        <td align="left" class="tdstyle" colspan="4">
            <asp:TextBox ID="txtDescription1" runat="server" Height="40px" TextMode="MultiLine" ></asp:TextBox></td>
    </tr>
            ...
            <tr>
                <td class="tdstyle" align="left">
                    <strong>
                    <asp:Label ID="lblpro"
                        runat="server" Text="Is the problem type accurate from supplier point of view ?" Width="107px"></asp:Label> </strong>
                </td>
                  <td align="left" class="tdstyle" colspan="4" >
            ...
            <tr>
                <td class="tdstyle" align="left" >
                    <strong>
                      <asp:Label ID="lblcat" runat="server" Text="If not, please assign a category from the list provided If single category, select here.If multiple categories, type categories from this list in the next cell.If 'Other', specify further details in the next cell. " Width="120px"></asp:Label></strong>
                </td>
    ...
    <tr>
        <td align="left" class="tdstyle" style="height: 32px; width: 440px;">
            <strong>
                  <asp:Label ID="lblFol" runat="server" Text="Is T&f follow-up action required?" Height="35px" Width="108px"></asp:Label></strong>
        </td>
        <td align="left" class="tdstyle" colspan="4" style="height: 32px">
                    <asp:DropDownList ID="dropFlowUp" runat="server" AutoPostBack="false">
                    <asp:ListItem>-- Select --</asp:ListItem>
                    <asp:ListItem>Yes</asp:ListItem>
                    <asp:ListItem>No</asp:ListItem>
                    </asp:DropDownList></td>
