<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sales_Localization_summary.aspx.cs"
    Inherits="sales_Localization_summary" ValidateRequest="false"%>
    ...
    <form id="form1" runat="server">
        <div>
            <div id="invreport" class="dptitle">
                <asp:Label ID="lblTitle" runat="server">Lead Summary</asp:Label></div>
        </div>
        ...
        <asp:GridView ID="gvPubSummary" runat="server" CssClass="lightbackground" Width="100%"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Customer Name">
                    <ItemTemplate>
                        <a class="link1" href="#pop" onclick="javascript:window.location='sales_Localization_info.aspx?slno=<%# Eval("salesleadno")%>'"><%# Eval("slcompany")%></a>                        
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="FollowUp Details">
                    <ItemTemplate>
                        <%# Eval("FollowUp")%>
                    </ItemTemplate>
                </asp:TemplateField>
