<%@ page maintainscrollpositiononpostback="true" language="C#" autoeventwireup="true" inherits="LaunchPage, App_Web_mjsvsc11" %>
                                           ...
                                           <asp:GridView ID="GvNL" runat="server" AutoGenerateColumns="False"  Font-Size="8pt"  
                                            ...
                                            <Columns>
                                               ...
                                               <asp:TemplateField SortExpression="File" HeaderText="No. of Files" >
                                                ...
                                                <asp:TemplateField HeaderText="Status" ItemStyle-Width="50"  ItemStyle-HorizontalAlign="Center" Visible="false" >
                                                     <ItemTemplate>
                             ...
                             <table id="Table5" border="0" cellpadding="2" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td colspan="3">
                                        ...
                                        <asp:CheckBox ID="chkNewYTC" Text="YTC" runat="server" />
