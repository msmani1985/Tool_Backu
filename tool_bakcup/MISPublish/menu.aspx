<%@ page language="C#" autoeventwireup="true" inherits="menu, App_Web_mjsvsc11" %>
...
<body style="background:white;">
    <form id="frmmenu" runat="server" >  
        ...
        <div id="livemenus" runat="server" style="width: auto; overflow:none;margin-top:5px;" >
        Loading...
        </div>
        <%--<div id="messagediv" runat="server" style="width: auto; overflow:nonde;" >
