<%@ page language="C#" autoeventwireup="true" inherits="projectmodule, App_Web_mjsvsc11" %>
    ...
    HeaderStyle-CssClass="darkbackground" ShowFooter="true">
        <Columns>
            ...
            <asp:TemplateField HeaderText="PE Contact Name">
                <ItemTemplate>
                    <asp:DropDownList ID="ddl_pename" runat="server" Width="200px" DataSource='<%# loadpename() %>'  DataTextField="invdisplayname" DataValueField="CONNO" SelectedValue='<%# DataBinder.Eval(Container.DataItem,"CONNO") %>'></asp:DropDownList>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField>
            <ItemTemplate>
