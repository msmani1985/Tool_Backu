<%@ page language="C#" autoeventwireup="true" inherits="Launch_Overciew, App_Web_znvsjrxn" enableeventvalidation="false" %>
        ...
        <asp:GridView ID="grdLaunchView" runat="server"  AutoGenerateColumns="false"
          ...
          PageSize="7" OnRowCommand="grdLaunch_RowCommand" OnRowDataBound="grdLaunch_RowDataBound" DataKeyNames="Pro_name">
            ...
            <asp:TemplateField ItemStyle-HorizontalAlign="Center">
               ...
               <asp:TemplateField SortExpression="cost"  ItemStyle-HorizontalAlign="Center">
                     <HeaderTemplate> Page or Hour
                            <asp:DropDownList ID="drpcost" Width="100" runat="server" OnSelectedIndexChanged="drpcost_SelectedIndexChanged" AutoPostBack="True" >
                            </asp:DropDownList>
                     </HeaderTemplate>
                     <ItemTemplate>
