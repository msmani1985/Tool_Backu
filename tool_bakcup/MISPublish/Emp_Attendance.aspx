<%@ page maintainscrollpositiononpostback="true" language="C#" autoeventwireup="true" inherits="Emp_Attendance, App_Web_zfrrxy20" %>
       ...
       <table class="bordertable" style="width: 780px; height: 60px">
           ...
           <tr>
               <td colspan="5" align="center" class="auto-style2">
                   <asp:Label ID="lblTotalHrs" Text="Total Hrs:" runat="server" style="font-weight: 700"></asp:Label>
                   <asp:Label  ID="txtTotalHrs" Width="100" runat="server"></asp:Label>
               
                   <asp:Label ID="lblMis" Text="Late Mins :" runat="server" style="font-weight: 700"></asp:Label>
                   <asp:Label ID="txtLateMins" runat="server"></asp:Label>
               </td>
           </tr>
    <tr>
        <td colspan="5" align="center"    >
            <asp:GridView ID="grvrpt" runat="server"  autogeneratecolumns="false" 
                                    EmptyDataText="No data available."  HeaderStyle-CssClass="FixedHeader" Font-Size="9pt" Width="614px" >
