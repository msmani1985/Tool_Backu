<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CharlesworthQMS_StyleSheet.aspx.cs" Inherits="CharlesworthQMS_StyleSheet" %>
       ...
       <tr>
         ...
         <tr class="dpJobGreenHeader">
                                    <td colspan="4" style="height: 32px">
                                        ...
                                        <asp:ImageButton ID="imgAdd" src="images/tools/add.png" runat="server" OnClick="imgAdd_Click" Visible="false" />
        ...
        <asp:GridView ID="grdStyleSheet" runat="server"  AutoGenerateColumns="false" Width="100%"
           EmptyDataText="No data available." Font-Size="8pt"  
          PageSize="7" OnRowDataBound="grdStyleSheet_RowDataBound" OnRowCommand="grdStyleSheet_RowCommand" DataKeyNames="Journal_code" OnSorting="grdStyleSheet_Sorting"  AllowSorting="True" OnRowEditing="grdStyleSheet_RowEditing" OnRowCancelingEdit="grdStyleSheet_RowCancelingEdit" >
            ...
            <asp:TemplateField>
                ...
                <asp:BoundField DataField="Journal_code"  SortExpression="Journal_code" HeaderText="Journal Acronym" >
                    <ItemStyle HorizontalAlign="Center" Width="11px" />
                                       ...
                                       <asp:BoundField DataField="Journal_Name"  SortExpression="Journal_Name" HeaderText="Journal Titile" >
                    <ItemStyle HorizontalAlign="left" Width="150px" />
                </asp:BoundField>
                <asp:BoundField DataField="Trim" HeaderText="Trim Size">
                 ...
                 <ItemTemplate>
                   <asp:ImageButton ID="imgStylesheet" runat="server"  ImageUrl="~/images/QMS/pdf.png" CommandName="Stylesheet"/>
                 </ItemTemplate>
                 ...
                 <ItemTemplate>
                   <asp:ImageButton ID="imgSample" runat="server"  ImageUrl="~/images/QMS/pdf.png" CommandName="Sample"/>
                 </ItemTemplate>
                       <ItemStyle HorizontalAlign="Center" Width="10px" />
                </asp:TemplateField>
                 ...
                 <ItemTemplate>
                   <asp:ImageButton ID="imgMarkupSample" runat="server"  ImageUrl="~/images/QMS/pdf.png" CommandName="Markup_Sample"/>
                 </ItemTemplate>
                       <ItemStyle HorizontalAlign="Center" Width="10px" />
                </asp:TemplateField>
                
       
               <asp:TemplateField HeaderText="Type Spec." >
                 <ItemTemplate>
                   <asp:ImageButton ID="imgTypeSpec" runat="server"  ImageUrl="~/images/QMS/word.png" CommandName="Type_Spce"/>
                 </ItemTemplate>
                       <ItemStyle HorizontalAlign="Center" Width="10px" />
                </asp:TemplateField>
