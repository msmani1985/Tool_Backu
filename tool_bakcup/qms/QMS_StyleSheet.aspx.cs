...
public partial class QMS_StyleSheet : System.Web.UI.Page
{
    ...
    string userName = "dpiuser171";//ConfigurationManager.ConnectionStrings["iUsername"].ConnectionString;
    string domain = "192.9.200.218";//ConfigurationManager.ConnectionStrings["iDomain"].ConnectionString;
    string password = "dpi701";//ConfigurationManager.ConnectionStrings["iPassword"].ConnectionString;
    ...
    private DataSet Employee()
    {
        ...
        return GetDataSet("select employee_id from employee where employee_id in (2422,2416,2056,1732,2016,978,1074,1847,2258,2432)", CommandType.Text);
    }
    ...
    protected void grdStyleSheet_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        try
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                using (new Impersonator("dpiuser171", domain, "dpi701"))
                {
                    //    //string strPath = @"//192.9.200.174/qms/STYLESHEETS & CHECKLISTS/" + strJournal;
                   //string strPath = "//dpserver7//CopyEditing//JOURNALS//STYLESHEETS & CHECKLISTS//" + strJournal;
                    string strPath = @"\\192.9.200.218\QMS\STYLESHEETS&CHECKLISTS\" + strJournal;
                ...
                {
                    string strPathSAM = @"\\dpserver7\QMS\SAM_Profilesheets_latest\" + strJournal;
                ...
                using (new Impersonator("dpiuser171", "192.9.200.196", "dpi701"))
                {
    ...
    protected void grdStyleSheet_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        else if (e.CommandName == "SAM Profile" && Page.IsValid)
        {
            using (new Impersonator(userName, domain, password))
            {
                ...
                string strPath = @"//dpserver7/QMS/SAM_Profilesheets_latest/" + sJournalCode;
