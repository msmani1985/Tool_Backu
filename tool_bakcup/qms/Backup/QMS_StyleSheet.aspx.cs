...
public partial class QMS_StyleSheet : System.Web.UI.Page
{
        ...
        try
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                using (new Impersonator(userName, domain, password))
                {
                    ...
                    string strPath = @"//192.9.200.218/CopyEditing/JOURNALS/STYLESHEETS & CHECKLISTS/" + strJournal;
                ...
                using (new Impersonator(userName, domain, password))
                {
                    //string strPathSAM = @"//dpserver2/QMS/SAM Profilesheets_latest/" + strJournal;
                    string strPathSAM = @"//192.9.200.218/CopyEditing/JOURNALS/SAM Profilesheets_latest/" + strJournal;
    ...
    protected void grdStyleSheet_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "Style Sheet" && Page.IsValid)
        {
            ...
            //string strPath = @"//dpserver2/db/QMS/Stylesheet/";
           // string strPath = @"//dpserver2/QMS/STYLESHEETS & CHECKLISTS/" + sJournalCode;
        ...
        else if (e.CommandName == "SAM Profile" && Page.IsValid)
        {
           ...
           // string strPath = @"//dpserver2/QMS/SAM Profilesheets_latest/" + sJournalCode;
    ...
    protected void grdStyleSheet_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
